...
export default {
  ...
  methods: {
    ...
    goDetail (item) {
      ...
      const url = `${basePath}/#/detailsEn?data=${queryData}&meeting_id=${this.meeting_id}&poster_banner_status=${this.poster_banner_status}&like_status=${this.like_status}&watermark=${this.watermark || ''}&pageUrl=${encodeURIComponent(window.location.href)}`
